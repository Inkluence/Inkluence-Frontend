...
const InfluencersGridCard = () => {
    const [students, setStudentsList] = useState(CreatorsList.slice(0, 500));
                    ...
                    <Card className="mb-5">
                        <Card.Body>
                            <div className="text-center">
                                ...
                                {/*<p className="mb-0">*/}
                                {/*    <FeatherIcon icon="map-pin" size="12" className="me-1 fs-6" />*/}
                                {/*    {students.locations}*/}
                                {/*</p>*/}
                            </div>
    ...
    const getSearchTerm = (event) => {
        ...
        if (searchTerm !== '') {
            const newStudentsList = CreatorsList.filter((student) => {
            ...
            setStudentsList(CreatorsList.slice(0, 500));
        }
    };
...
export default InfluencersGridCard;
